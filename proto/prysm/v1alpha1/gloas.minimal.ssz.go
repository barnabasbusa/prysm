...
func (p *PayloadAttestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(p.AggregationBits); size != 2 {
...
func (p *PayloadAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if cap(p.AggregationBits) == 0 {
		p.AggregationBits = make([]byte, 0, len(buf[0:2]))
	}
	p.AggregationBits = append(p.AggregationBits, buf[0:2]...)

	// Field (1) 'Data'
	if p.Data == nil {
		p.Data = new(PayloadAttestationData)
	}
	if err = p.Data.UnmarshalSSZ(buf[2:44]); err != nil {
		return err
	}

	// Field (2) 'Signature'
	if cap(p.Signature) == 0 {
		p.Signature = make([]byte, 0, len(buf[44:140]))
	}
	p.Signature = append(p.Signature, buf[44:140]...)
...
func (b *BeaconBlockBodyGloas) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	offset += len(b.PayloadAttestations) * 140
...
func (b *BeaconBlockBodyGloas) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o11:o12]
		num, err := ssz.DivideInt2(len(buf), 140, 4)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.PayloadAttestations[ii].UnmarshalSSZ(buf[ii*140 : (ii+1)*140]); err != nil {
				return err
			}
		}
	}
...
func (b *BeaconBlockBodyGloas) SizeSSZ() (size int) {
	...
	// Field (11) 'PayloadAttestations'
	size += len(b.PayloadAttestations) * 140
...
func (b *BeaconStateGloas) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(b.ExecutionPayloadAvailability); size != 8 {
		err = ssz.ErrBytesLengthFn("--.ExecutionPayloadAvailability", size, 8)
		return
	}
	...
	if size := len(b.PayloadExpectedWithdrawals); size > 4 {
		err = ssz.ErrListTooBigFn("--.PayloadExpectedWithdrawals", size, 4)
		return
	}
...
func (b *BeaconStateGloas) UnmarshalSSZ(buf []byte) error {
	...
	if cap(b.LatestBlockHash) == 0 {
		b.LatestBlockHash = make([]byte, 0, len(buf[10229:10261]))
	}
	b.LatestBlockHash = append(b.LatestBlockHash, buf[10229:10261]...)

	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint[uint64](buf[10261:10269])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = ssz.UnmarshallUint[github_com_OffchainLabs_prysm_v7_consensus_types_primitives.ValidatorIndex](buf[10269:10277])

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[10277:10281]); o27 > size || o21 > o27 {
		return ssz.ErrOffset
	}

	// Field (28) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint[uint64](buf[10281:10289])

	// Field (29) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = ssz.UnmarshallUint[github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Gwei](buf[10289:10297])

	// Field (30) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = ssz.UnmarshallUint[github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Gwei](buf[10297:10305])

	// Field (31) 'EarliestExitEpoch'
	b.EarliestExitEpoch = ssz.UnmarshallUint[github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Epoch](buf[10305:10313])

	// Field (32) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = ssz.UnmarshallUint[github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Gwei](buf[10313:10321])

	// Field (33) 'EarliestConsolidationEpoch'
	b.EarliestConsolidationEpoch = ssz.UnmarshallUint[github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Epoch](buf[10321:10329])

	// Offset (34) 'PendingDeposits'
	if o34 = ssz.ReadOffset(buf[10329:10333]); o34 > size || o27 > o34 {
		return ssz.ErrOffset
	}

	// Offset (35) 'PendingPartialWithdrawals'
	if o35 = ssz.ReadOffset(buf[10333:10337]); o35 > size || o34 > o35 {
		return ssz.ErrOffset
	}

	// Offset (36) 'PendingConsolidations'
	if o36 = ssz.ReadOffset(buf[10337:10341]); o36 > size || o35 > o36 {
		return ssz.ErrOffset
	}
	...
	for ii := 0; ii < 16; ii++ {
		b.ProposerLookahead[ii] = ssz.UnmarshallUint[github_com_OffchainLabs_prysm_v7_consensus_types_primitives.ValidatorIndex](buf[10341:10469][ii*8 : (ii+1)*8])
	}

	// Offset (38) 'Builders'
	if o38 = ssz.ReadOffset(buf[10469:10473]); o38 > size || o36 > o38 {
		return ssz.ErrOffset
	}

	// Field (39) 'NextWithdrawalBuilderIndex'
	b.NextWithdrawalBuilderIndex = ssz.UnmarshallUint[github_com_OffchainLabs_prysm_v7_consensus_types_primitives.BuilderIndex](buf[10473:10481])

	// Field (40) 'ExecutionPayloadAvailability'
	if cap(b.ExecutionPayloadAvailability) == 0 {
		b.ExecutionPayloadAvailability = make([]byte, 0, len(buf[10481:10489]))
	}
	b.ExecutionPayloadAvailability = append(b.ExecutionPayloadAvailability, buf[10481:10489]...)
	...
	for ii := 0; ii < 16; ii++ {
		...
		if err = b.BuilderPendingPayments[ii].UnmarshalSSZ(buf[10489:11321][ii*52 : (ii+1)*52]); err != nil {
			return err
		}
	}

	// Offset (42) 'BuilderPendingWithdrawals'
	if o42 = ssz.ReadOffset(buf[11321:11325]); o42 > size || o38 > o42 {
		return ssz.ErrOffset
	}

	// Offset (43) 'LatestExecutionPayloadBid'
	if o43 = ssz.ReadOffset(buf[11325:11329]); o43 > size || o42 > o43 {
		return ssz.ErrOffset
	}

	// Offset (44) 'PayloadExpectedWithdrawals'
	if o44 = ssz.ReadOffset(buf[11329:11333]); o44 > size || o43 > o44 {
		return ssz.ErrOffset
	}
...
func (p *PTCs) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(p.ValidatorIndices); size != 16 {
		err = ssz.ErrVectorLengthFn("--.ValidatorIndices", size, 16)
		return
	}
	for ii := 0; ii < 16; ii++ {
...
func (p *PTCs) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'ValidatorIndices'
	p.ValidatorIndices = ssz.ExtendUint(p.ValidatorIndices, 16)
	for ii := 0; ii < 16; ii++ {
		p.ValidatorIndices[ii] = ssz.UnmarshallUint[github_com_OffchainLabs_prysm_v7_consensus_types_primitives.ValidatorIndex](buf[0:128][ii*8 : (ii+1)*8])
	}
